...
namespace Scafolding.Controllers
{
    public class ProfesorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Clave,Nombre,Apellidos")] Profesor profesor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Clave,Nombre,Apellidos")] Profesor profesor)
        {
            if (ModelState.IsValid)
            {
